...
public class NodeApproved {
    ...
    public static void insertIfNotExist(Connection connection, NodeApproved model) throws SQLException {
        String sql = "INSERT IGNORE INTO NodeApproved VALUES (?,?,?,?,?)";
        ...
        if(result > 0) {
            System.out.println("new nodeApproved event : " + model);
        }
        statement.close();
    }
